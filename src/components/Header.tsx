        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="w-full max-w-sm p-6 bg-zinc-900 rounded-xl shadow-lg border border-zinc-800">
            ...
            <div className="my-4 p-3 bg-zinc-950 rounded-lg border border-zinc-700 text-center">
              ...
              <p className="text-lg font-mono text-white">support$payid.crypto.com</p>
            </div>
              ...
              <button 
                onClick={() => {
                  ...
                  if (amount && !isNaN(Number(amount))) {
                    handleDepositViaPayID(Number(amount));
                  } else if (addLog) {
                    addLog('[PAYID] Invalid amount entered.');
                  }
                }} 
                className="w-full py-2 bg-emerald-500 hover:bg-emerald-400 text-zinc-900 font-bold rounded-lg transition-colors"
              >
                Confirm Deposit
              </button>
              <button 
